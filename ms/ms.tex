...
We summarized population-level coefficients, after factoring out Treatment and other effects, using principal components. Spec
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in model.frame.default(formula = ord.sd \textasciitilde{} ., data = u, na.action = function (x) : variable lengths differ (found for 'u')}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'vsurfPC1' not found}}\begin{alltt}
  \hlstd{nImpPC1} \hlkwb{<-} \hlkwd{length}\hlstd{(imp2)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'imp2' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'nImpPC1' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in points(vsurfPC1\$ord.imp\$x[1:nImpPC1], nImpLat:(nImpLat - nImpPC1 + : object 'vsurfPC1' not found}}\begin{alltt}
