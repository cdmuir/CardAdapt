...
The observation that populations are locally adapted to their environment is old and well-documented in many species. New frontiers in local adaptation research aim at a general understanding of why local adaptation sometimes suceeds and other times fails, why certain traits respond to selection whereas others are constrained, and what are the important environmental drivers of local adaptation [CITES such as Kawecki]. Understanding why and how populations adapt to different environments is especially significant for predicting how species' ranges will shift under climate change. In this study, we found evidence for one of two common signature of local adaptation, pointing to both phenotypic lability and constraint. ...
